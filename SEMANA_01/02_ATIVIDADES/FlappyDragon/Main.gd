...
var status = 1 # variável que define o status, se o jogo está rodando ou está parado
var vscore = 0 # variável que controla a pontuação
var x = 1.5 # variável que controla a posição e a velocidade do background no eixo horizontal
var y = 2.0 # variável que controla a posição e a velocidade do dragão no eixo vertical 
